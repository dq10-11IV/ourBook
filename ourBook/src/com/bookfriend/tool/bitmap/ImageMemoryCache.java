package com.bookfriend.tool.bitmap;
...
public class ImageMemoryCache {
    ...
    private static ImageMemoryCache imMemoryCache;
    public static ImageMemoryCache getMemCache(Context context){
    	
    	if(imMemoryCache==null){
    		synchronized (ImageMemoryCache.class) {
				if(imMemoryCache==null){
					imMemoryCache = new ImageMemoryCache(context);
