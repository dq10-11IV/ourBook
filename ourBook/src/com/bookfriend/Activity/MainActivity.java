...
import com.bookfriend.Fragment.AboutFragment;
import com.bookfriend.Fragment.LabelFragment;
import com.bookfriend.Fragment.LocationFragment;
import com.bookfriend.Fragment.MybookFragment;
import com.bookfriend.Fragment.ScanbookFragment;
import com.bookfriend.Fragment.SearchFragment;
import com.bookfriend.Fragment.SettingFragment;
import com.bookfriend.R;
import com.bookfriend.model.BookInfo;
import com.bookfriend.tools.Util;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerList.setAdapter(new ArrayAdapter<String>(this, R.layout.item_drawer, mPlanetTitles));
	...
	private Handler hd = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			try {
				Fragment fragment = new ScanbookFragment(book);
